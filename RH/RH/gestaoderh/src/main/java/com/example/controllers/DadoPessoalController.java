...
public void atualizarDadoProfissional() {
    ...
    tabPaneAtualizar.getSelectionModel().select(tabAtualizarProfissional);
        ...
        private void preencherCamposAtualizacaoPessoal() {
            DadoPessoal dadopessoalSelecionado = tableDadoPessoal.getSelectionModel().getSelectedItem();
            if (dadopessoalSelecionado!= null) {
                idDadoPessoalSelecionado = dadopessoalSelecionado.getId();
                txtNaturalidadeAtualizarFunc.setText(dadopessoalSelecionado.getNaturalidade());
                txtCpfAtualizarFunc.setText(dadopessoalSelecionado.getCpf());
                txtRgAtualizarFunc.setText(dadopessoalSelecionado.getRg());
                comboBoxSexoAtualizarFunc.setValue(dadopessoalSelecionado.getSexo());
                txtDataNascimentoAtualizarFunc.setText(dadopessoalSelecionado.getData_nascimento());
                txtNomeAtualizarFunc.setText(dadopessoalSelecionado.getNome_completo());;
            ...
            private void preencherCamposAtualizacaoProfissional() {
            ...
            if (dadoprofissionalSelecionado!= null) {
                txtpisAtualizarFunc.setText(dadoprofissionalSelecionado.getPis());
                ...
                comboBoxescolaridadeAtualizarFunc.setValue(dadoprofissionalSelecionado.getEscolaridade());
                ...
                txtctpsAtualizarFunc.setText(dadoprofissionalSelecionado.getCtps());
                txtadmissaoAtualizarFunc.setText(dadoprofissionalSelecionado.getAdmissao());
